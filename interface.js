...
function getSentence(){
    let spanList = document.getElementById("uebungsaufgabe").getElementsByTagName("h2")[0].getElementsByTagName("span");
    let satzZusammen = "";  
    for(var item of spanList){
        satzZusammen += item.innerHTML + " ";
    }
    satzZusammen += document.getElementById("uebungsaufgabe").getElementsByTagName("h2")[0].lastChild.nodeValue.trim();
    return satzZusammen;
}
...
function writeSentence(sentence){
    ...
    let sentenceTag = document.getElementById("uebungsaufgabe").getElementsByTagName("h2")[0]
